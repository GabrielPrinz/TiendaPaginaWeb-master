       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo"></small></h1>
            </div>
                      ...
                      <div class="col-xs-12 col-sm-6 col-md-4">
                           <div class="thumbnail">
                             ...
                             <div class="caption">
                               ...
                               <p class="text-center">
                                   <a style="background-color: #9C408A; color: #FFD700;" href="infoProd.php?CodigoProd=<?php echo $prod['CodigoProd']; ?>" class="btn btn-primary btn-raised btn-sm btn-block"><i class="fa fa-plus"></i>&nbsp;  Ver Producto</a>
                               </p>
