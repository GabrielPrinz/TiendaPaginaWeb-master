...
?>
<nav id="navbar-auto-hidden" style="background-color: #9C408A;">
        <div class="row hidden-xs">
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo"><img src="https://s3.amazonaws.com/orion-eat-app-files/orioneat-prod%2FwQuduccfCyAoqssBe-logo-Tambo.png" alt="Logo" width="120" height="50"></p>
            </div>
            <div class="col-xs-8">
          ...
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            <div class="modal-header">
              ...
              <p class="text-center text-primary">
                <i class="fa fa-user-circle-o fa-3x" aria-hidden="true" style="color: #9C408A;"></i>
              </p>
              <h4 class="modal-title text-center text-primary" id="myModalLabel" style="color: #9C408A;">Iniciar sesión</h4>
            </div>
            <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login" >
                <div class="form-group label-floating">
                    <label class="control-label" style="color: #9C408A;"><span class="glyphicon glyphicon-user" style="color: #9C408A;"></span>&nbsp;Nombre</label >
                    <input type="text" class="form-control" name="nombre-login" required="">
                </div>
                <div class="form-group label-floating">
                    <label class="control-label" style="color: #9C408A;"><span class="glyphicon glyphicon-lock" style="color: #9C408A;"></span>&nbsp;Contraseña</label>
                    <input type="password" class="form-control" name="clave-login" required="">
                </div>

                <p>¿Cómo iniciaras sesión?</p>
               
                <div class="radio" style="color: #9C408A;">
                  <label style="color: #9C408A;">
                      <input type="radio" name="optionsRadios" value="option1" checked="" style="color: #9C408A;">
                      Usuario
                  </label>
               </div>
               ...
               <div class="radio" style="color: #9C408A;">
                  <label style="color: #9C408A;">
                      <input type="radio" name="optionsRadios" value="option2" style="color: #9C408A;">
                       Administrador
                  </label>
               </div>
