       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1><img src="https://images.emojiterra.com/google/android-nougat/512px/1f383.png" alt="Logo" width="120" height="100"> <small class="tittles-pages-logo">Productos</small></h1>
            </div>
            <?php
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12 col-md-4">
                    <div class="dropdown">
                      <button style="background-color: #9C408A; color: #FFD700;" class="btn btn-primary btn-raised dropdown-toggle" type="button" id="drpdowncategory" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      ...
                      <div class="form-group">
                        <div class="input-group">
                          ...
                          <span class="input-group-btn">
                              <button style="background-color: #9C408A; color: #FFD700;" class="btn btn-info btn-raised" type="submit">Buscar</button>
                          </span>
                        </div>
                      </div>
                    </form>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail">
                           ...
                           <div class="caption">
                             ...
                             <?php endif; ?>
                             <p class="text-center">
                                 <a style="background-color: #9C408A; color: #FFD700;"href="infoProd.php?CodigoProd=<?php echo $prod['CodigoProd']; ?>" class="btn btn-primary btn-raised btn-sm btn-block"><i class="fa fa-plus"></i>&nbsp; Detalles</a>
                             </p>
